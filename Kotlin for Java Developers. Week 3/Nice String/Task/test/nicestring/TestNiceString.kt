...
class TestNiceString {
    ...
    private fun testNiceString(text: String, expected: Boolean) {
        Assert.assertEquals("Wrong result for \"$text\".isNice()", expected, text.isNice())
    }

    @Test
    fun testExample0() = testNiceString("braeim", true)
